                                          ...
                                          Matrix3d &Rotation, Vector3d &Translation)
{
    ...
    Matrix3d rota = Sophus::SO3d::exp(Eigen::Vector3d(rvec.at<double>(0, 0), rvec.at<double>(1, 0), rvec.at<double>(2, 0))).matrix();
    
    // Sophus::SO3<double> SO3_R(Eigen::Vector3d(rvec.at<double>(0, 0), rvec.at<double>(1, 0), rvec.at<double>(2, 0)));
    // Matrix3d rota = SO3_R.matrix();
